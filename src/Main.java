...
class MainWindow extends JFrame {
    ...
    private void initializeUI() {
        ...
        tabbedPane.insertTab("Daily Usage", new ImageIcon(Objects.requireNonNull(getClass().getResource("home.png"))),dailyUsagePanel,"Adding daily transaction here.",0);
        tabbedPane.insertTab("Client List", new ImageIcon(Objects.requireNonNull(getClass().getResource("client.png"))),clientPanel,"Adding, editing and deleting client list here..",1);
        tabbedPane.insertTab("Medicine Stock", new ImageIcon(Objects.requireNonNull(getClass().getResource("medicine.png"))),medicinePanel,"Updating medicine stock here..",2);
...
class MedicinePanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        addButton(toolBar, "Add", new ImageIcon(Objects.requireNonNull(getClass().getResource("add.png"))), "Add new medicine", this::showAddDialog, KeyEvent.VK_ADD);
        addButton(toolBar, "Edit", new ImageIcon(Objects.requireNonNull(getClass().getResource("edit.png"))), "Edit selected", this::showEditDialog, KeyEvent.VK_E);
        addButton(toolBar, "Delete", new ImageIcon(Objects.requireNonNull(getClass().getResource("delete.png"))), "Delete selected", this::deleteMedicines, KeyEvent.VK_MINUS);
        addButton(toolBar, "Refresh", new ImageIcon(Objects.requireNonNull(getClass().getResource("refresh.png"))), "Refresh data", _ -> refreshData(), KeyEvent.VK_F1);
...
class ClientPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        JToolBar toolBar = new JToolBar();
        toolBar.setFloatable(false);
        addButton(toolBar, "Add", new ImageIcon(Objects.requireNonNull(getClass().getResource("add.png"))), "Add new client", _ -> showAddDialog(), KeyEvent.VK_ADD);
        addButton(toolBar, "Edit", new ImageIcon(Objects.requireNonNull(getClass().getResource("edit.png"))), "Edit selected", _ -> showEditDialog(), KeyEvent.VK_S);
        addButton(toolBar, "Delete", new ImageIcon(Objects.requireNonNull(getClass().getResource("delete.png"))), "Delete selected", _ -> deleteClients(), KeyEvent.VK_MINUS);
        addButton(toolBar, "Refresh", new ImageIcon(Objects.requireNonNull(getClass().getResource("refresh.png"))), "Refresh data", _ -> refreshData(), KeyEvent.VK_F1);
        toolBar.add(new JLabel("   Search :   ")).setFont(new Font("DejaVu",Font.BOLD,20));
        toolBar.add(searchField,BorderLayout.WEST);
        statusLabel = new JLabel(" Ready");
...
class TransactionPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        JToolBar toolBar = new JToolBar();
        toolBar.setFloatable(false);
        addButton(toolBar, "Add", new ImageIcon(Objects.requireNonNull(getClass().getResource("add.png"))), "Add new transaction", _ -> showAddDialog());
        addButton(toolBar, "Delete", new ImageIcon(Objects.requireNonNull(getClass().getResource("delete.png"))), "Delete selected", _ -> deleteTransactions());
        addButton(toolBar, "Set payed", new ImageIcon(Objects.requireNonNull(getClass().getResource("coin.png"))), "Set selected as payed", _ -> setTransactionsPayed());
        addButton(toolBar, "Refresh", new ImageIcon(Objects.requireNonNull(getClass().getResource("refresh.png"))), "Refresh data", _ -> refreshData());
...
class DailyUsagePanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        addButton(todayToolbar, "Add", new ImageIcon(Objects.requireNonNull(getClass().getResource("add.png"))), _ -> showAddDialog());
        addButton(todayToolbar, "Delete", new ImageIcon(Objects.requireNonNull(getClass().getResource("delete.png"))), _ -> deleteTodayTransactions());
        addButton(todayToolbar, "Set payed", new ImageIcon(Objects.requireNonNull(getClass().getResource("coin.png"))), _ -> setTransactionsPayed());
        addButton(todayToolbar, "Refresh", new ImageIcon(Objects.requireNonNull(getClass().getResource("refresh.png"))), _ -> refreshData());
